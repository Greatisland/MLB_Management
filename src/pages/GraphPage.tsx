...
const GraphPage = () => {
  ...
  return (
    <GraphPageContainer>
      ...
      <MeetingType meetData={meetData} yearView={yearView} setYearView={setYearView} monthView={monthView} setMonthView={setMonthView} />
      {loginUser.level >= 2 ? <BasicStats membersData={membersData} /> : null}

      <HostRanking meetData={meetData} yearView={yearView} setYearView={setYearView} monthView={monthView} setMonthView={setMonthView}/>
