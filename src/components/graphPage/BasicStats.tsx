...
import { totalyAttend } from "../../lib/totalyAttend.ts"
  ...
  return (
    <BasicStatsContainer>
      ...
      <div className='content'>
        ...
        <span className='content_body'><span className="add_text">평균 월</span>{totalyAttend(totalMember)}<span className="add_text">회</span></span>
      </div>
      <div className='content'>
